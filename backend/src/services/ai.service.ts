...
/**
 * Transform AI result into frontend-ready format
 * Ensures all required arrays exist even if empty
 */
export function transformToFrontendFormat(aiResult: AIResult): FrontendExtractedData {
